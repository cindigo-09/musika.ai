...
export default function PlaylistDetails() {
  ...
  const addSongToPlaylist = async (songId) => {
    // Append to bottom using the current length of the playlist as order_index
  ...
  return (
    ...
    >
          ...
          <div className="d-flex flex-column flex-md-row gap-5 align-items-md-end mb-5">
            ...
            <div className="flex-grow-1">
              ...
              <div className="d-flex gap-3 align-items-center">
                ...
                {/* REPEAT BUTTON */}
                <button
                  className={`btn rounded-circle p-3 ${repeatMode !== "none" ? "btn-info" : "btn-outline-light"}`}
      ...
      {/* Add Song Modal (logic updated to append) */}
      {showAddModal && (
        <div
